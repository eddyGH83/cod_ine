...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {        
        this.model = [
            ...
            {
                label: 'Gestion de usuarios', icon: 'pi pi-fw pi-users',
                items: [
...

            {
                ...
                items: [
                    ...
                    {
                        label: 'Matriz de Ocupación | Actividad Económica', icon: 'pi pi-fw pi-bookmark', routerLink: ['/diccionarios/matriz-ocupacion-actividad-economica']
                    }
                ]
            },

            {
                label: 'Codificación', icon: 'pi pi-fw pi-sort-alpha-down',
                items: [
                    {
                    ...
                    {
                        label: 'Supervisar Codificación', icon: 'pi pi-fw pi-sort-numeric-down', routerLink: ['/codificacion/supervisar-codificacion']
                    }
                ]
            },

            {
                ...
                items: [
                    { label: 'ODBC', icon: 'pi pi-fw pi-table', routerLink: ['/odbc'] }
                ]
            },
            {
                label: 'Reportes', icon: 'pi pi-fw pi-search-plus',
                items: [
            ...
            {
                label: 'Codificación', icon: 'pi pi-fw pi-search-plus',
                items: [
                    { label: 'Codificar', icon: 'pi pi-fw pi-table', routerLink: ['/usuCodificador'] }
                ]
            },
